...
import { Code, Github, Linkedin, Twitter, Mail, ArrowUp } from 'lucide-react'
            ...
            >
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-10 h-10 bg-dark-800 border border-gray-700 rounded-lg flex items-center justify-center text-gray-400 hover:text-primary-500 hover:border-primary-500 transition-all duration-300"
